  ...
  SwaggerUi = (function(_super) {
    ...
    SwaggerUi.prototype.initialize = function(options) {
      ...
      this.options.failure = function(d) {
        return _this.onLoadFailure(d, options.doneFailure);
      };
    ...
    SwaggerUi.prototype.render = function(options) {
      var _this = this;
    ...
    SwaggerUi.prototype.onLoadFailure = function(data, doneFailure) {
      var val;
      if (data == null) {
        data = '';
      }
